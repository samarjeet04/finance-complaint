...
from finance_complaint.component import DataIngestion, DataTransformation, DataValidation, ModeTrainer, ModelPusher, ModelEvaluation
from finance_complaint.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact, \
    DataTransfomrationArtifact, ModelTrainerArtifact, ModelEvaluationArtifact
...
class TrainingPipeline:
    ...
    def start_model_trainer(self, data_transformation_artifact: DataTransfomrationArtifact) -> ModelTrainerArtifact:
        try:
            model_trainer = ModeTrainer(data_transformation_artifact=data_transformation_artifact,
